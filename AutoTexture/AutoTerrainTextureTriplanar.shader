...
Shader "iffnsShaders/WorldTools/AutoTexture/AutoTerrainTexture"
{
	...
	SubShader
	{
		...
		inline float4 TriplanarSampling519( UNITY_DECLARE_TEX2D_NOSAMPLER(topTexMap), SamplerState samplertopTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
		{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float CliffSplat284 = saturate( ( ( ase_normalWS.y - temp_output_1_0_g687 ) / ( ( temp_output_22_0_g686 - temp_output_20_0_g686 ) - temp_output_1_0_g687 ) ) );
			...
			float temp_output_463_12 = ( ( 1.0 - CliffSplat284 ) * saturate( ( ( ase_positionWS.y - temp_output_1_0_g927 ) / ( ( temp_output_1_0_g926 + temp_output_9_0_g926 ) - temp_output_1_0_g927 ) ) ) );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 triplanar519 = TriplanarSampling519( __Clifftexture, sampler__Clifftexture, ase_positionWS, ase_normalWS, 1.0, __Clifftexture_ST.xy, 1.0, 0 );
			float temp_output_22_0_g686 = cos( ( _CliffthresholdDeg * 0.01745328 ) );
			float temp_output_20_0_g686 = ( 0.01745328 * _Cliffblend );
			float temp_output_1_0_g687 = ( temp_output_22_0_g686 + temp_output_20_0_g686 );
			float CliffSplat284 = saturate( ( ( ase_normalWS.y - temp_output_1_0_g687 ) / ( ( temp_output_22_0_g686 - temp_output_20_0_g686 ) - temp_output_1_0_g687 ) ) );
			float2 appendResult261 = (float2(ase_positionWS.x , ase_positionWS.z));
			...
			float Level3Splat293 = ( ( ( 1.0 - CliffSplat284 ) * saturate( ( ( ase_positionWS.y - temp_output_1_0_g950 ) / ( ( temp_output_1_0_g949 + temp_output_9_0_g949 ) - temp_output_1_0_g950 ) ) ) ) * InvertedSnowSplat468 );
			...
			float Level2Splat295 = ( ( ( 1.0 - CliffSplat284 ) * ( saturate( ( ( ase_positionWS.y - temp_output_1_0_g945 ) / ( ( temp_output_1_0_g944 - temp_output_9_0_g944 ) - temp_output_1_0_g945 ) ) ) - saturate( ( ( ase_positionWS.y - temp_output_1_0_g947 ) / ( ( temp_output_1_0_g946 - temp_output_9_0_g946 ) - temp_output_1_0_g947 ) ) ) ) ) * InvertedSnowSplat468 );
			float temp_output_1_0_g952 = ( 0.0 + _Height12 );
			float temp_output_9_0_g952 = _Blend12;
			float temp_output_1_0_g953 = ( temp_output_1_0_g952 + temp_output_9_0_g952 );
			float Level1Splat296 = ( ( ( 1.0 - CliffSplat284 ) * saturate( ( ( ase_positionWS.y - temp_output_1_0_g953 ) / ( ( temp_output_1_0_g952 - temp_output_9_0_g952 ) - temp_output_1_0_g953 ) ) ) ) * InvertedSnowSplat468 );
			float4 AutoAlbedo459 = ( ( triplanar519 * CliffSplat284 ) + ( SAMPLE_TEXTURE2D( _SnowTexture, sampler_SnowTexture, ( ( UVCoordinate259 * _SnowTexture_ST.xy ) + _SnowTexture_ST.zw ) ) * SnowSplat465 ) + ( SAMPLE_TEXTURE2D( _Texture3, sampler_Texture3, ( ( UVCoordinate259 * _Texture3_ST.xy ) + _Texture3_ST.zw ) ) * Level3Splat293 ) + ( SAMPLE_TEXTURE2D( _Texture2, sampler_Texture2, ( ( UVCoordinate259 * _Texture2_ST.xy ) + _Texture2_ST.zw ) ) * Level2Splat295 ) + ( SAMPLE_TEXTURE2D( _Texture1, sampler_Texture1, ( ( UVCoordinate259 * _Texture1_ST.xy ) + _Texture1_ST.zw ) ) * Level1Splat296 ) );
			float2 uv_Control = i.uv_texcoord * _Control_ST.xy + _Control_ST.zw;
			float4 tex2DNode506 = SAMPLE_TEXTURE2D( _Control, sampler_Control, uv_Control );
			float4 tex2DNode5_g957 = SAMPLE_TEXTURE2D( _Control, sampler_Control, uv_Control );
			float dotResult20_g957 = dot( tex2DNode5_g957 , float4(1,1,1,1) );
			float SplatWeight22_g957 = dotResult20_g957;
			float localSplatClip74_g957 = ( SplatWeight22_g957 );
			float SplatWeight74_g957 = SplatWeight22_g957;
			{
			#if !defined(SHADER_API_MOBILE) && defined(TERRAIN_SPLAT_ADDPASS)
				clip(SplatWeight74_g957 == 0.0f ? -1 : 1);
			#endif
			}
			float4 SplatControl26_g957 = ( tex2DNode5_g957 / ( localSplatClip74_g957 + 0.001 ) );
			float4 temp_output_59_0_g957 = SplatControl26_g957;
			float4 appendResult33_g957 = (float4(1.0 , 1.0 , 1.0 , _Smoothness0));
			float2 uv_Splat0 = i.uv_texcoord * _Splat0_ST.xy + _Splat0_ST.zw;
			float4 tex2DNode4_g957 = SAMPLE_TEXTURE2D( _Splat0, sampler_Splat0, uv_Splat0 );
			float3 _Vector1 = float3(1,1,1);
			float4 appendResult258_g957 = (float4(_Vector1 , 1.0));
			float4 tintLayer0253_g957 = appendResult258_g957;
			float4 appendResult36_g957 = (float4(1.0 , 1.0 , 1.0 , _Smoothness1));
			float2 uv_Splat1 = i.uv_texcoord * _Splat1_ST.xy + _Splat1_ST.zw;
			float4 tex2DNode3_g957 = SAMPLE_TEXTURE2D( _Splat1, sampler_Splat1, uv_Splat1 );
			float3 _Vector2 = float3(1,1,1);
			float4 appendResult261_g957 = (float4(_Vector2 , 1.0));
			float4 tintLayer1254_g957 = appendResult261_g957;
			float4 appendResult39_g957 = (float4(1.0 , 1.0 , 1.0 , _Smoothness2));
			float2 uv_Splat2 = i.uv_texcoord * _Splat2_ST.xy + _Splat2_ST.zw;
			float4 tex2DNode6_g957 = SAMPLE_TEXTURE2D( _Splat2, sampler_Splat2, uv_Splat2 );
			float3 _Vector3 = float3(1,1,1);
			float4 appendResult263_g957 = (float4(_Vector3 , 1.0));
			float4 tintLayer2255_g957 = appendResult263_g957;
			float4 appendResult42_g957 = (float4(1.0 , 1.0 , 1.0 , _Smoothness3));
			float2 uv_Splat3 = i.uv_texcoord * _Splat3_ST.xy + _Splat3_ST.zw;
			float4 tex2DNode7_g957 = SAMPLE_TEXTURE2D( _Splat3, sampler_Splat3, uv_Splat3 );
			float3 _Vector4 = float3(1,1,1);
			float4 appendResult265_g957 = (float4(_Vector4 , 1.0));
			float4 tintLayer3256_g957 = appendResult265_g957;
			float4 weightedBlendVar9_g957 = temp_output_59_0_g957;
			float4 weightedBlend9_g957 = ( weightedBlendVar9_g957.x*( appendResult33_g957 * tex2DNode4_g957 * tintLayer0253_g957 ) + weightedBlendVar9_g957.y*( appendResult36_g957 * tex2DNode3_g957 * tintLayer1254_g957 ) + weightedBlendVar9_g957.z*( appendResult39_g957 * tex2DNode6_g957 * tintLayer2255_g957 ) + weightedBlendVar9_g957.w*( appendResult42_g957 * tex2DNode7_g957 * tintLayer3256_g957 ) );
			float4 MixDiffuse28_g957 = weightedBlend9_g957;
			float4 temp_output_60_0_g957 = MixDiffuse28_g957;
			float4 localClipHoles100_g957 = ( temp_output_60_0_g957 );
			float2 uv_TerrainHolesTexture = i.uv_texcoord * _TerrainHolesTexture_ST.xy + _TerrainHolesTexture_ST.zw;
			float holeClipValue99_g957 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture ).r;
			float Hole100_g957 = holeClipValue99_g957;
			{
			#ifdef _ALPHATEST_ON
				clip(Hole100_g957 == 0.0f ? -1 : 1);
			#endif
			}
			o.Albedo = ( ( AutoAlbedo459 * tex2DNode506.r ) + ( ( 1.0 - tex2DNode506.r ) * localClipHoles100_g957 ) ).xyz;
...
Node;AmplifyShaderEditor.CommentaryNode;237;3434.786,847.5234;Inherit;False;2609.445;2345.209;Texture assignment;38;459;310;301;300;302;304;303;309;177;178;305;175;306;307;176;308;383;406;401;396;405;395;382;400;380;272;404;299;410;398;394;399;407;392;397;411;402;518;;0,0,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;279;1939.535,1839.224;Inherit;False;TerrainHeightToSplatBottom;-1;;951;2c6309721afd4e747a528bf7483f5d16;0;3;4;FLOAT;0;False;5;FLOAT;0;False;17;FLOAT;0;False;1;FLOAT;10
...
Node;AmplifyShaderEditor.FunctionNode;292;2346.929,1778.581;Inherit;False;TerrainCombineLevelAndSteepnessSplat;-1;;954;6f98bedd32a6e404dbb05d96831fad96;0;2;5;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;12
Node;AmplifyShaderEditor.FunctionNode;286;2350.36,1329.664;Inherit;False;TerrainCombineLevelAndSteepnessSplat;-1;;955;6f98bedd32a6e404dbb05d96831fad96;0;2;5;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;12
...
Node;AmplifyShaderEditor.FunctionNode;290;2356.017,1559.681;Inherit;False;TerrainCombineLevelAndSteepnessSplat;-1;;956;6f98bedd32a6e404dbb05d96831fad96;0;2;5;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;12
...
Node;AmplifyShaderEditor.TexturePropertyNode;411;3616,912;Inherit;True;Property;__Clifftexture;Clifftexture;35;0;Create;False;0;0;0;False;0;False;None;62df36f05b105a54ea5fc2526d0fc2b1;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TextureTransformNode;410;3920,1168;Inherit;False;-1;False;1;0;SAMPLER2D;;False;2;FLOAT2;0;FLOAT2;1
Node;AmplifyShaderEditor.WorldPosInputsNode;520;3936,1008;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;177;4558.483,2217.931;Inherit;True;Property;s;s;34;0;Create;False;0;0;0;False;0;False;-1;None;e0c0f250770eef24994a6a31d68c5f67;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;175;4543.572,1353.574;Inherit;True;Property;;;0;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;176;4551.978,1776.23;Inherit;True;Property;d;s;30;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;178;4558.076,2647.396;Inherit;True;Property;a;a;37;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TriplanarNode;519;4480,976;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;-1;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;300;5196.165,1062.685;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;310;5590.859,1441.383;Inherit;False;5;5;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;459;5820.875,1452.704;Inherit;False;AutoAlbedo;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;506;6134.121,1622.1;Inherit;True;Property;_Control;Control;27;1;[HideInInspector];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.OneMinusNode;509;6554.257,1717.042;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;505;6137.489,1868.44;Inherit;False;Four Splats First Pass Terrain;0;;957;37452fdfb732e1443b7e39720d05b708;2,102,1,85,0;7;59;FLOAT4;0,0,0,0;False;60;FLOAT4;0,0,0,0;False;61;FLOAT3;0,0,0;False;57;FLOAT;0;False;58;FLOAT;0;False;201;FLOAT;0;False;62;FLOAT;0;False;7;FLOAT4;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;19;FLOAT3;17
Node;AmplifyShaderEditor.GetLocalVarNode;507;6302.738,1428.728;Inherit;False;459;AutoAlbedo;1;0;OBJECT;;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;508;6778.085,1638.375;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;511;6971.121,1724.709;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;8008.779,1842.029;Float;False;True;-1;2;;0;0;Standard;iffnsShaders/WorldTools/AutoTexture/AutoTerrainTexture;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;Nature/Terrain/Standard;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;True;0.1;False;;0;False;;True;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;519;0;411;0
WireConnection;519;9;520;0
WireConnection;519;3;410;0
...
ASEEND*/
//CHKSM=B8ECA5B627B715C75FC41017C897426B7983FDE5