...
Shader "iffnsShaders/WorldTools/AutoTexture/AutoTerrainTexture"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode5_g944 = SAMPLE_TEXTURE2D( _Control, sampler_Control, uv_Control );
			float dotResult20_g944 = dot( tex2DNode5_g944 , float4(1,1,1,1) );
			float SplatWeight22_g944 = dotResult20_g944;
			float localSplatClip74_g944 = ( SplatWeight22_g944 );
			float SplatWeight74_g944 = SplatWeight22_g944;
			{
			#if !defined(SHADER_API_MOBILE) && defined(TERRAIN_SPLAT_ADDPASS)
				clip(SplatWeight74_g944 == 0.0f ? -1 : 1);
			#endif
			}
			float4 SplatControl26_g944 = ( tex2DNode5_g944 / ( localSplatClip74_g944 + 0.001 ) );
			float4 temp_output_59_0_g944 = SplatControl26_g944;
			float2 uv_Splat0 = i.uv_texcoord * _Splat0_ST.xy + _Splat0_ST.zw;
			float2 uv_Splat1 = i.uv_texcoord * _Splat1_ST.xy + _Splat1_ST.zw;
			float2 uv_Splat2 = i.uv_texcoord * _Splat2_ST.xy + _Splat2_ST.zw;
			float2 uv_Splat3 = i.uv_texcoord * _Splat3_ST.xy + _Splat3_ST.zw;
			float4 weightedBlendVar8_g944 = temp_output_59_0_g944;
			float4 weightedBlend8_g944 = ( weightedBlendVar8_g944.x*SAMPLE_TEXTURE2D( _Normal0, sampler_Normal0, uv_Splat0 ) + weightedBlendVar8_g944.y*SAMPLE_TEXTURE2D( _Normal1, sampler_Normal1, uv_Splat1 ) + weightedBlendVar8_g944.z*SAMPLE_TEXTURE2D( _Normal2, sampler_Normal2, uv_Splat2 ) + weightedBlendVar8_g944.w*SAMPLE_TEXTURE2D( _Normal3, sampler_Normal3, uv_Splat3 ) );
			float3 temp_output_61_0_g944 = UnpackNormal( weightedBlend8_g944 );
			...
			float temp_output_23_0_g933 = 0.0;
			float temp_output_1_0_g935 = ( _Height23 + temp_output_23_0_g933 );
			float temp_output_9_0_g935 = _Blend23;
			float temp_output_1_0_g936 = ( temp_output_1_0_g935 + temp_output_9_0_g935 );
			float temp_output_1_0_g937 = ( temp_output_23_0_g933 + _Height12 );
			float temp_output_9_0_g937 = _Blend12;
			float temp_output_1_0_g938 = ( temp_output_1_0_g937 + temp_output_9_0_g937 );
			float Level2Splat295 = ( ( ( 1.0 - CliffSplat284 ) * ( saturate( ( ( ase_worldPos.y - temp_output_1_0_g936 ) / ( ( temp_output_1_0_g935 - temp_output_9_0_g935 ) - temp_output_1_0_g936 ) ) ) - saturate( ( ( ase_worldPos.y - temp_output_1_0_g938 ) / ( ( temp_output_1_0_g937 - temp_output_9_0_g937 ) - temp_output_1_0_g938 ) ) ) ) ) * InvertedSnowSplat468 );
			...
			float2 temp_output_406_0 = ( ( Level1Splat296 * _Texture1_ST.xy ) + _Texture1_ST.zw );
			...
			o.Normal = ( ( temp_output_509_0 * temp_output_61_0_g944 ) + ( tex2DNode506.r * AutoNormal457 ) );
			...
			float4 appendResult33_g944 = (float4(1.0 , 1.0 , 1.0 , _Smoothness0));
			float4 tex2DNode4_g944 = SAMPLE_TEXTURE2D( _Splat0, sampler_Splat0, uv_Splat0 );
			float3 _Vector1 = float3(1,1,1);
			float4 appendResult258_g944 = (float4(_Vector1 , 1.0));
			float4 tintLayer0253_g944 = appendResult258_g944;
			float4 appendResult36_g944 = (float4(1.0 , 1.0 , 1.0 , _Smoothness1));
			float4 tex2DNode3_g944 = SAMPLE_TEXTURE2D( _Splat1, sampler_Splat1, uv_Splat1 );
			float3 _Vector2 = float3(1,1,1);
			float4 appendResult261_g944 = (float4(_Vector2 , 1.0));
			float4 tintLayer1254_g944 = appendResult261_g944;
			float4 appendResult39_g944 = (float4(1.0 , 1.0 , 1.0 , _Smoothness2));
			float4 tex2DNode6_g944 = SAMPLE_TEXTURE2D( _Splat2, sampler_Splat2, uv_Splat2 );
			float3 _Vector3 = float3(1,1,1);
			float4 appendResult263_g944 = (float4(_Vector3 , 1.0));
			float4 tintLayer2255_g944 = appendResult263_g944;
			float4 appendResult42_g944 = (float4(1.0 , 1.0 , 1.0 , _Smoothness3));
			float4 tex2DNode7_g944 = SAMPLE_TEXTURE2D( _Splat3, sampler_Splat3, uv_Splat3 );
			float3 _Vector4 = float3(1,1,1);
			float4 appendResult265_g944 = (float4(_Vector4 , 1.0));
			float4 tintLayer3256_g944 = appendResult265_g944;
			float4 weightedBlendVar9_g944 = temp_output_59_0_g944;
			float4 weightedBlend9_g944 = ( weightedBlendVar9_g944.x*( appendResult33_g944 * tex2DNode4_g944 * tintLayer0253_g944 ) + weightedBlendVar9_g944.y*( appendResult36_g944 * tex2DNode3_g944 * tintLayer1254_g944 ) + weightedBlendVar9_g944.z*( appendResult39_g944 * tex2DNode6_g944 * tintLayer2255_g944 ) + weightedBlendVar9_g944.w*( appendResult42_g944 * tex2DNode7_g944 * tintLayer3256_g944 ) );
			float4 MixDiffuse28_g944 = weightedBlend9_g944;
			float4 temp_output_60_0_g944 = MixDiffuse28_g944;
			float4 localClipHoles100_g944 = ( temp_output_60_0_g944 );
			float2 uv_TerrainHolesTexture = i.uv_texcoord * _TerrainHolesTexture_ST.xy + _TerrainHolesTexture_ST.zw;
			float holeClipValue99_g944 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture ).r;
			float Hole100_g944 = holeClipValue99_g944;
			{
			#ifdef _ALPHATEST_ON
				clip(Hole100_g944 == 0.0f ? -1 : 1);
			#endif
			}
			o.Albedo = ( ( AutoAlbedo459 * tex2DNode506.r ) + ( temp_output_509_0 * localClipHoles100_g944 ) ).rgb;
...
/*ASEBEGIN
Version=18935
503;108;1388;772;-3774.401;-2238.641;1.194455;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;86;1571.496,1211.449;Inherit;False;Property;_SnowBlend;SnowBlend;27;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;1573.97,1138.807;Inherit;False;Property;_SnowHeight;SnowHeight;26;0;Create;True;0;0;0;False;0;False;35;36.38;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;278;1949.666,1592.433;Inherit;False;TerrainHeightToSplatMiddle;-1;;933;83724a7e3c36a4a489f9cbbe3da25c42;0;5;14;FLOAT;0;False;11;FLOAT;0;False;12;FLOAT;0;False;23;FLOAT;0;False;13;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;403;3919.358,2704.632;Inherit;False;296;Level1Splat;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;290;2356.017,1559.681;Inherit;False;TerrainCombineLevelAndSteepnessSplat;-1;;942;6f98bedd32a6e404dbb05d96831fad96;0;2;5;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;12
Node;AmplifyShaderEditor.FunctionNode;286;2350.36,1329.664;Inherit;False;TerrainCombineLevelAndSteepnessSplat;-1;;943;6f98bedd32a6e404dbb05d96831fad96;0;2;5;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;12
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;405;4202.996,2734.324;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;505;6137.489,1868.44;Inherit;False;Four Splats First Pass Terrain;0;;944;37452fdfb732e1443b7e39720d05b708;2,85,0,102,1;7;59;FLOAT4;0,0,0,0;False;60;FLOAT4;0,0,0,0;False;61;FLOAT3;0,0,0;False;57;FLOAT;0;False;58;FLOAT;0;False;201;FLOAT;0;False;62;FLOAT;0;False;7;FLOAT4;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;19;FLOAT3;17
...
Node;AmplifyShaderEditor.RangedFloatNode;354;7394.629,2116.404;Inherit;False;Property;_SnowDepth;SnowDepth;45;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=7FD38D8C121794BDD49A3A282B5FC1D127FC0168